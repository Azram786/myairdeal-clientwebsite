    ...
    <div className="container mx-auto py-12">
      <div className="flex flex-col-reverse md:px-16 md:flex-row items-center">
        <div className="md:w-1/2 w-[90%] md:mt-0 mt-2">
          <h2 className="text-base font-sans text-[#1B1D29] font-bold">About us</h2>
          <h1 className="text-xl sm:text-3xl font-bold font-sans mb-2">My <span className='text-[#D7B56D]'>Air</span> Deal</h1>
          <p className="text-[#1B1D29] text-base font-semibold mb-6">Welcome to My <span className='text-[#D7B56D]'>Air</span> Deal, your go-to flight ticket booking app for hassle-free travel planning.</p>

          <div className="mb-8">
            <div className="flex items-center mb-2">
              <div className="bg-[#1B1D29] p-2 rounded-full">
