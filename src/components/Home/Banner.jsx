...
const Banner = ({ setLoading }) => {
  ...
  return (
    <div className="relative min-w-[250px] h-[60vh] max-w-[1900px] mx-auto   lg:h-[70vh]">
      <div className="relative w-full h-full overflow-hidden">
        {banners.map((banner, index) => (
          <img
            key={index}
      ...
      <button
        onClick={prevSlide}
        className="hidden sm:block absolute top-1/2 left-4 transform -translate-y-1/2 bg-black bg-opacity-50 text-white p-2 rounded-full"
        style={{ width: "40px", height: "40px" }}
      >
        &#10094;
      </button>
      <button
        onClick={nextSlide}
        className="hidden sm:block absolute top-1/2 right-4 transform -translate-y-1/2 bg-black bg-opacity-50 text-white p-2 rounded-full"
        style={{ width: "40px", height: "40px" }}
      >
        &#10095;
      </button>
