    ...
    <div className="h-full  bg-[#092945] mx-auto text-white w-full ">
      ...
      >
        <div className="w-[100%] md:w-[20%]  flex  md:flex-col justify-center items-center  md:gap-5 pt-2 ">
          <div
            className="flex justify-start px-4 md:px-4  md:justify-center items-center gap-2 w-[100%]
             "
          >
            <div className="flex">
              <img src={Logo} alt="" />
        ...
        <div className="flex md:w-3/4 text-center md:text-start pb-6 sm:pb-0 ">
          <div className="grid md:grid-cols-5 sm:grid-cols-3 px-6 py-4 md:px-0 grid-cols-2 text-start  w-full place-content-start">
            <div className="text-white  font-light flex flex-col gap-1  ">
