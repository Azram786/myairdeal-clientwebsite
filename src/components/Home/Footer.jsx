        ...
        <div className="justify-center flex gap-20 flex-wrap md:gap-48 pl-0 md:pl-[110px]">
          <div>
            ...
            <p className="font-normal text-base md:text-sm text-white">
              2nd Floor, Anjali Plaza, BTM Layout,
            </p>
            <p className="font-normal text-base md:text-sm text-white">
          ...
          <div>
            ...
            <br />
            <p
              className="font-normal text-base md:text-sm text-white cursor-pointer hover:text-[#D7B56D]"
              onClick={() => {
                window.open(
            ...
            <p
              className="font-normal text-base md:text-sm text-white cursor-pointer hover:text-[#D7B56D] mt-2"
              onClick={() => {
                window.open(
                  "https://packages.myairdeal.com/",
                  "_blank",
                  "noopener,noreferrer"
                );
              }}
