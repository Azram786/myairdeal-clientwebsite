      ...
      {loading ? (
        ...
        <div className="  p-2 border rounded-lg md:px-10  mt-3  flex justify-center items-center  ">
          <div className=" flex flex-col w-full   ">
            <div className=" bg-slate-500 border-2 gap-2 flex flex-wrap justify-between items-center text-[#D7B56D] rounded-xl px-10   py-4">
              ...
              <div className="flex gap-3">
                ...
                <div className="">
                  <button
                    className="bg-slate-600 border-white border-2 flex justify-center items-center text-[#D7B56D] p-2 w-[200px] rounded-lg"
