                ...
                return (
                    <div className="flex flex-col md:flex-row items-center justify-between bg-blue-100 border-t border-blue-200 rounded-lg p-4" key={value.id}>
                        <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-700">{timeFormatChanger(value.time)}</p>
                            <p className="text-sm text-gray-700">{dateDateFormatChanger(value.time)}</p>
                        </div>
                        <button
                                    ...
                                    <div className="bg-white p-6 rounded-lg shadow-md">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div className="bg-blue-50 p-4 rounded-md">
                                                <div className="text-sm font-medium text-gray-600">Amendment ID:</div>
                                                <div className="text-lg font-semibold text-blue-700">{amendmentData?.amendmentId}</div>
                                            </div>
                                            <div className="bg-blue-50 p-4 rounded-md">
                                                <div className="text-sm font-medium text-gray-600">Amendment Status:</div>
                                                <div className="text-lg font-semibold text-blue-700">{amendmentData?.amendmentStatus}</div>
                                            </div>
                                            <div className="bg-blue-50 p-4 rounded-md">
                                                <div className="text-sm font-medium text-gray-600">Booking ID:</div>
                                                <div className="text-lg font-semibold text-blue-700">{amendmentData?.bookingId}</div>
                                            </div>
                                            <div className="bg-blue-50 p-4 rounded-md">
                                                <div className="text-sm font-medium text-gray-600">Refundable Amount:</div>
                                                <div className="text-lg font-semibold text-blue-700">{amendmentData?.refundableAmount}</div>
                                            </div>
                                            <div className="bg-blue-50 p-4 rounded-md md:col-span-2">
                                                <div className="text-sm font-medium text-gray-600">Remarks:</div>
                                                <div className="text-lg font-semibold text-blue-700">{amendmentData?.remarks}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="bg-white p-6 rounded-lg shadow-md">
                                        <div className="text-lg font-semibold text-gray-800 mb-4">Trip Details</div>
                                        {trips.map((trip, index) => (
                                            <div key={index} className="mb-4 border-b pb-4  px-1">
                                                <div className="mb-2">
                                                    <span className="font-medium  text-gray-700">Source:</span> {trip.src}
                                                </div>
                                                <div className="mb-2">
                                                    <span className="font-medium text-gray-700">Destination:</span> {trip.dest}
                                                </div>
                                                <div className="mb-2">
                                                    <span className="font-medium text-gray-700">Departure Date:</span> {trip.departureDate}
                                                </div>
                                                <div className="mb-2">
                                                    <span className="font-medium text-gray-700">Flight Numbers:</span> {trip.flightNumbers.join(", ")}
                                                </div>
                                                <div className="mb-2">
                                                    <span className="font-medium text-gray-700">Airlines:</span> {trip.airlines.join(", ")}
                                                </div>
                                                <div className="mt-4">
                                                    <div className="font-medium text-gray-700 mb-2">Travellers:</div>
                                                    {trip.travellers.map((traveller, i) => (
                                                        <div key={i} className="bg-slate-300 p-2 rounded-md mb-2">
                                                            <div>
                                                                <span className="font-medium text-gray-600">Name:</span> {traveller.fn} {traveller.ln}
                                                            </div>
                                                            <div>
                                                                <span className="font-medium text-gray-600">Amendment Charges:</span> {traveller.amendmentCharges}
                                                            </div>
                                                            <div>
                                                                <span className="font-medium text-gray-600">Refundable Amount:</span> {traveller.refundableamount}
                                                            </div>
                                                            <div>
                                                                <span className="font-medium text-gray-600">Total Fare:</span> {traveller.totalFare}
                                                            </div>
                                                        </div>
                                                    ))}
                                                </div>
