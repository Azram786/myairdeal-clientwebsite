...
//   useEffect(() => {
//     // Save passengers, gstDetails, and contactDetails to localStorage
//     localStorage.setItem('passengers', JSON.stringify(passengers));
//     localStorage.setItem('gstDetails', JSON.stringify(gstDetails));
//     localStorage.setItem('contactDetails', JSON.stringify(contactDetails));
//   }, [passengers, gstDetails, contactDetails]);
...
const AddDetails = ({
  ...
  useEffect(() => {
    ...
    const savedGstDetails = JSON.parse(localStorage.getItem('gstDetails')) || {
      gstNumber: "",
      companyName: "",
      address: "",
      email: "",
    ...
    setGstDetails(savedGstDetails);
    setContactDetails(savedContactDetails);
  }, [setPassengers, setGstDetails, setContactDetails]);
