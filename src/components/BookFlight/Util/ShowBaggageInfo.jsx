...
const BaggageInformation = ({ item }) => {
  ...
  return (
    <div className="  rounded-lg w-[85%] gap-2 mx-auto flex justify-between items-center  ">
      <div className=" ">
        ...
        <div className='text-5xl'><LuBaggageClaim />  </div>
      </div>
      ...
      <div className="  
       flex justify-between 
        ...
        {passengerTypes.map((type) => (
          <div key={type} className=" w-1/3 bg-blue-50 rounded-md p-3 flex flex-col items-start text-sm">
      ...
      <div className="text-center mt-4">
        <a href="#" className="text-blue-500 underline inline-block  text-sm">Fare details</a>
      </div>
    </div>
  );
};
