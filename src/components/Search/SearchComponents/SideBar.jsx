...
const SideBar = ({
  ...
  useEffect(() => {
    if (flights[activeTabIndex] && flights[activeTabIndex].length > 0) {
      const maxPrice =Math.floor( Math.max(
  ...
  return (
    <div className="flex flex-row text-xs md:text-base min-w-[250px] border p-4 m-2 shadow-md rounded-md md:min-h-screen">
      <div className="grid gap-2 w-full grid-cols-1">
        ...
        <div className="mb-6 border-b border-gray-300 pb-4">
          ...
          <div className="grid grid-flow-row w-full grid-cols-2 md:grid-cols-2 lg:grid-cols-4  ">
